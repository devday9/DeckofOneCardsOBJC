...
@implementation DLDCardController

+ (void)drawANewCard:(NSInteger)numberOfCards completion:(void (^)(NSArray<DLDCard *> * _Nullable))completion
{
    ...
    [[[NSURLSession sharedSession] dataTaskWithURL:searchURL completionHandler:^(NSData * _Nullable data, NSURLResponse * _Nullable response, NSError * _Nullable error) {
        ...
        {
            DLDCard *card = [[DLDCard alloc] initWithDictionary:cardDictionary];
...
+ (void)fetchCardImage:(DLDCard *)card completion:(void (^)(UIImage * _Nullable))completion
{
